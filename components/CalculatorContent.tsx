...
const CalculatorContent: React.FC = () => {
  ...
  const initialActive = (['sip', 'swp', 'lumpsum', 'tax'].includes(paramActive || '') ? paramActive : null) as CalculatorType | null;

  const [activeCalculator, setActiveCalculator] = useState<CalculatorType | null>(initialActive);
  ...
  const renderCalculator = () => {
    switch (activeCalculator) {
      case 'sip':
        return <SIPCalculator onBack={handleBack} />;
      case 'swp':
        return <SWPCalculator onBack={handleBack} />;
      case 'lumpsum':
        return <LumpsumCalculator onBack={handleBack} />;
      case 'tax':
        return <IncomeTaxCalculator onBack={handleBack} />;
      default:
