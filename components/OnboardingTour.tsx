...
const tourSteps = [
  {
    ...
    content: 'Start your investment journey here! Get personalized SIP plans with fund recommendations, asset allocation strategies, and realistic growth projections - all powered by AI and tailored to your financial goals.',
    position: 'bottom',
  },
  {
    ...
    content: 'Visualize your complete investment strategy! View detailed asset allocation charts, year-by-year growth projections, recommended mutual funds with ratings, and export your plan as a professional PDF report.',
    position: 'bottom',
  },
  {
    ...
    title: '📚 Learn & Grow',
    content: 'Knowledge is power! Explore educational articles on SIPs, mutual funds, tax-saving strategies, and asset allocation. Test your financial IQ with the FinIQ Challenge quiz featuring 3 difficulty levels.',
    position: 'bottom',
  },
  {
    ...
    content: 'Powerful financial tools at your fingertips! Calculate SIP returns with step-up, project lumpsum investments, plan retirement withdrawals (SWP), and estimate income tax for FY 2024-25. All calculators offer multiple scenarios.',
    position: 'bottom',
  },
  {
    ...
    content: 'Enhance your investment journey! Find certified financial advisors near you with our interactive map locator, or challenge yourself with the AI-powered FinIQ quiz to test and improve your financial knowledge.',
    position: 'bottom',
  },
];
