...
import { Fund, Page, GrowthDataPoint } from '../types';
import {
  ResponsiveContainer,
  PieChart,
  Pie,
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          {!isExporting && (
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
              ...
              <button onClick={handleCreateNewPlan} className="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-sm hover:bg-blue-700 transition-colors justify-center">
                Create New Plan
              </button>
            </div>
          )}
