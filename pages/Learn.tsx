...
type Category = 'All' | 'Foundations' | 'Analysis' | 'Strategy' | 'Risk & Tax';
...
const topicsData: Topic[] = [
  ...
  },
  {
    ...
    readTime: '3 min',
    iconKey: 'Red Flags to Watch', // Using generic alert icon
    content: `
  ...
  },
  {
    ...
    readTime: '4 min',
    iconKey: 'What is Expense Ratio?', // Reusing similar icon
    content: `
  ...
  },
  {
    ...
    readTime: '4 min',
    iconKey: 'Mutual Funds vs. Stocks', // Reusing relevant icon
    content: `
  ...
  },
  {
    ...
    readTime: '3 min',
    iconKey: 'Asset Allocation', // Reusing relevant icon
    content: `
  ...
  },
  {
    ...
    readTime: '2 min',
    iconKey: 'What is Expense Ratio?', // Similar concept
    content: `
...
const Learn: React.FC = () => {
  ...
  if (selectedTopic) {
    const Icon = learnIcons[selectedTopic.iconKey] || IconBook;
    return (
        <div className="max-w-4xl mx-auto px-4 py-6 animate-fade-in">
            ...
            >
                <div className="bg-slate-100 p-2 rounded-full mr-2 group-hover:bg-blue-100 transition-colors">
            ...
            <article className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 sm:p-12 text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-8 opacity-10">
                        <Icon className="h-48 w-48 text-white transform rotate-12 translate-x-12 -translate-y-12" />
                    </div>
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="flex items-center text-blue-100 text-xs font-medium">
                                <IconClock className="h-3 w-3 mr-1" /> {selectedTopic.readTime} Read
                            </span>
                        </div>
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight">{selectedTopic.title}</h1>
                        <p className="text-lg text-blue-100 max-w-2xl">{selectedTopic.description}</p>
                    </div>
                </div>
                ...
                <div className="p-8 sm:p-12">
                    <div 
                        ...
                        dangerouslySetInnerHTML={{ __html: parseMarkdownToHTML(selectedTopic.content) }} 
                    />
                </div>
                ...
                <div className="bg-slate-50 border-t border-slate-200 p-8 flex justify-between items-center">
                    <p className="text-sm text-slate-500 italic">
                        Was this article helpful? Check out more in the <button onClick={() => { setSelectedTopic(null); setActiveCategory(selectedTopic.category); }} className="text-blue-600 font-semibold hover:underline">{selectedTopic.category}</button> section.
                    </p>
                    <button 
                        onClick={() => setSelectedTopic(null)}
                        className="text-sm font-bold text-blue-600 hover:text-blue-800 transition-colors"
                    >
                        Read Another Article &rarr;
                    </button>
                </div>
            </article>
        </div>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-8 sm:p-12 text-white text-center mb-12 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
            ...
            <p className="text-lg text-blue-100 max-w-2xl mx-auto mb-8 leading-relaxed">
              Master the art of investing. From basics to advanced strategies, explore our curated library of financial wisdom.
            </p>
      ...
      <div className="flex flex-wrap justify-center gap-2 mb-10">
        {(['All', 'Foundations', 'Analysis', 'Strategy', 'Risk & Tax'] as Category[]).map(cat => (
          <button
            key={cat}
      ...
      {filteredTopics.length > 0 ? (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTopics.map(topic => {
                const Icon = learnIcons[topic.iconKey] || IconBook;
                return (
                    <button
                        key={topic.id}
                    ...
                    >
                        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-slate-50 to-blue-50 rounded-bl-full -mr-4 -mt-4 transition-transform group-hover:scale-110"></div>
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="text-xs font-semibold text-slate-400 bg-slate-100 px-2 py-1 rounded-md uppercase tracking-wider">
                                    {topic.category === 'Risk & Tax' ? 'Risk' : topic.category}
                                </span>
                            </div>
        ...
        <div className="text-center py-16 bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200">
            <div className="text-slate-300 mb-4">
                <IconBrainCircuit className="h-16 w-16 mx-auto" />
            </div>
            <h3 className="text-xl font-semibold text-slate-600">Topic not found in our library</h3>
            <p className="text-slate-500 mt-2 mb-6 max-w-md mx-auto">
                We couldn't find exactly what you're looking for here, but our AI assistant knows everything about investing!
            </p>
            <button 
                onClick={openChatbot}
            ...
            >
                <IconBrainCircuit className="h-5 w-5 mr-2" />
            ...
            <div className="mt-4">
                ...
                >
                    Clear filters and see all topics
                </button>
            </div>
        </div>
      )}
